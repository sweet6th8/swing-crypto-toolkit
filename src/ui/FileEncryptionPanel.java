...
public class FileEncryptionPanel extends JPanel implements DropTargetListener {
    ...
    private void updateModesAndPaddings() {
        ...
        // TODO: Get modes/paddings from actual EncryptionAlgorithm instances
        if (selectedAlgorithm != null) {
            ...
            if (isSymmetric || selectedAlgorithm.equals("ChaCha20Poly1305")) { // ChaCha also uses modes/padding
                                                                               // conceptually
                // Example modes
                ...
                if (selectedAlgorithm.equals("ChaCha20Poly1305")) {
                    // ChaCha20 typically uses AEAD mode (often implicit) and no padding
                    modeComboBox.setSelectedItem("None"); // Or AEAD if available
                ...
                modeComboBox.addItem("ECB"); // Often only ECB for raw RSA
                modeComboBox.setEnabled(false);
